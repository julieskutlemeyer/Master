...
class CondDDPM(nn.Module):
    ...
    def forward(self, x0, t, eta=None):
          ...
          part_two = (1 - self.alpha_bars[t].reshape(n, 1, 1, 1)).sqrt() * eta * 0.2
    ...
    for epoch in tqdm(range(n_epochs), desc=f"Training progress", colour="#00ff00"):
      ...
      #      show_images(generate_new_images(ddpm, device=device), f"Images generated at epoch {epoch + 1}")
       ...
       # if best_loss > epoch_loss:
        ...
        torch.save(ema_model.state_dict(), "ddpm_with_ema_t+l_no1sqrt2_50_epochs_lr1e4_label_bw.pt")
...
training_loop(model, loader, n_epochs, device, display=False, store_path="ddpm_fer2013_im2vec_siluresnet_t+l_50_epocks_lr1e4_label_bw.pt")

...
for batch in tqdm(loader):
  ...
  img_emo_emb.append([batch[0], batch[1], vectors])

torch.save(img_emo_emb, 'efficientnet_b7_img_emo_emb.pt')
print(img_emo_emb[0][0].shape, img_emo_emb[0][1].shape, img_emo_emb[0][2].shape) #torch.Size([128, 3, 64, 64]) torch.Size([128, 1]) torch.Size([128, 2560])
